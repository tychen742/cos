...
int main()
{
    ...
    int int_a = 100;                
    float float_a = 1.2345;             // variable with type float
    double double_a = 1.2345;           // variable with type double
    char char_a = 'B';                  // variable with type character "char"
    char char_b = 66;                   // variable with type character "char" with ASCII
    char char_c[] = "this is a string"; // variable with type character "char"
    ...
    // ########## size of type
    printf("\n");
    printf("##### The sizes of types in bytes #####\n");
    int myInt;
    float myFloat;
    double myDouble;
    char myChar;
    ...
    double int_source = 3.14;
    int int_b = int_source;
    ...
    printf("Constant PI has been declared: %f\n", const_PI);
